...
function generatePopup(layer, latlng) {
    ...
    L.popup()
        ...
        .setContent(jQuery.i18n.prop("advancedsearch.js.map.common.speciescount") + " <b id='speciesCountDiv'>" + jQuery.i18n.prop("advancedsearch.js.map.common.calculating") + "</b><br>" +
            jQuery.i18n.prop("advancedsearch.js.map.common.occurrencecount") + " <b id='occurrenceCountDiv'>" + jQuery.i18n.prop("advancedsearch.js.map.common.calculating") + "</b><br>" +
